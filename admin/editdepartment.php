...
$sql="update tbldepartments set departmentname=?,departmentcode=?,departmentshortname=? where id=?";
$query = $dbh->prepare($sql);
$query->bindParam(1,$deptname,PDO::PARAM_STR);
$query->bindParam(2,$deptcode,PDO::PARAM_STR);
$query->bindParam(3,$deptshortname,PDO::PARAM_STR);
$query->bindParam(4,$did,PDO::PARAM_STR);
$query->execute();
...
<?php 
$did=intval($_GET['deptid']);
$sql = "SELECT * from tbldepartments WHERE id=?";
$query = $dbh -> prepare($sql);
$query->bindParam(1,$did,PDO::PARAM_STR);
$query->execute();
