...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
$query = $dbh->prepare($sql);
$query->bindParam(1,$empid,PDO::PARAM_STR);
$query->bindParam(2,$fname,PDO::PARAM_STR);
$query->bindParam(3,$lname,PDO::PARAM_STR);
$query->bindParam(4,$email,PDO::PARAM_STR);
$query->bindParam(5,$password,PDO::PARAM_STR);
$query->bindParam(6,$gender,PDO::PARAM_STR);
$query->bindParam(7,$dob,PDO::PARAM_STR);
$query->bindParam(8,$department,PDO::PARAM_STR);
$query->bindParam(9,$address,PDO::PARAM_STR);
$query->bindParam(10,$city,PDO::PARAM_STR);
$query->bindParam(11,$country,PDO::PARAM_STR);
$query->bindParam(12,$mobileno,PDO::PARAM_STR);
$query->bindParam(13,$status,PDO::PARAM_STR);
$query->execute();
