...
if($query -> rowCount() > 0)
{
$con="update admin set password=? where username=?";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(1, $username, PDO::PARAM_STR);
$chngpwd1-> bindParam(2, $newpassword, PDO::PARAM_STR);
$chngpwd1->execute();
...
<html lang="en">
  ...
  include('/var/www/html/my code/elms/includes/header.php');?>
