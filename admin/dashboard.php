                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tblemployees.firstname,tblemployees.lastname,tblemployees.empid,tblemployees.id,tblleaves.leavetype,tblleaves.postingdate,tblleaves.status from tblleaves join tblemployees on tblleaves.id=tblemployees.id order by lid desc limit 6";
