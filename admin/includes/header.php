...
<?php   
$isread=0;
$sql = "SELECT id from tblleaves where isread=?";
$query = $dbh -> prepare($sql);

$query->bindParam(1,$isread,PDO::PARAM_STR);
...
$sql = "SELECT tblleaves.id as lid,tblemployees.firstname,tblemployees.lastname,tblemployees.empid,tblleaves.postingdate from tblleaves join tblemployees on tblleaves.useremail=tblemployees.id where tblleaves.isread=?;
$query = $dbh->prepare($sql);
